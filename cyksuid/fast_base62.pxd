...
cdef extern from "cbase62.h" nogil:
    int ksuid_b62_encode(signed char *dst, size_t dst_len, const unsigned char *src, size_t src_len)
    int ksuid_b62_decode(unsigned char *dst, size_t dst_len, const signed char *src, size_t src_len)
